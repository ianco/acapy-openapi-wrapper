...
*CredentialDefinitionApi* | [**credential_definitions_cred_def_id_write_record_post**](docs/CredentialDefinitionApi.md#credential_definitions_cred_def_id_write_record_post) | **POST** /credential-definitions/{cred_def_id}/write_record | Writes a credential definition non-secret record to the wallet
...
*DidExchangeApi* | [**didexchange_create_request_post**](docs/DidExchangeApi.md#didexchange_create_request_post) | **POST** /didexchange/create-request | Create and send a request against public DID&#39;s implicit invitation
...
*EndorseTransactionApi* | [**transactions_tran_id_write_post**](docs/EndorseTransactionApi.md#transactions_tran_id_write_post) | **POST** /transactions/{tran_id}/write | For Author / Endorser to write an endorsed transaction to the ledger
...
*IssueCredentialV10Api* | [**issue_credential_create_offer_post**](docs/IssueCredentialV10Api.md#issue_credential_create_offer_post) | **POST** /issue-credential/create-offer | Create a credential offer, independent of any proposal or connection
...
*IssueCredentialV20Api* | [**issue_credential20_create_offer_post**](docs/IssueCredentialV20Api.md#issue_credential20_create_offer_post) | **POST** /issue-credential-2.0/create-offer | Create a credential offer, independent of any proposal or connection
*IssueCredentialV20Api* | [**issue_credential20_create_post**](docs/IssueCredentialV20Api.md#issue_credential20_create_post) | **POST** /issue-credential-2.0/create | Create credential from attribute values
...
*MultitenancyApi* | [**multitenancy_wallet_post**](docs/MultitenancyApi.md#multitenancy_wallet_post) | **POST** /multitenancy/wallet | Create a subwallet
*MultitenancyApi* | [**multitenancy_wallet_wallet_id_get**](docs/MultitenancyApi.md#multitenancy_wallet_wallet_id_get) | **GET** /multitenancy/wallet/{wallet_id} | Get a single subwallet
*MultitenancyApi* | [**multitenancy_wallet_wallet_id_put**](docs/MultitenancyApi.md#multitenancy_wallet_wallet_id_put) | **PUT** /multitenancy/wallet/{wallet_id} | Update a subwallet
*MultitenancyApi* | [**multitenancy_wallet_wallet_id_remove_post**](docs/MultitenancyApi.md#multitenancy_wallet_wallet_id_remove_post) | **POST** /multitenancy/wallet/{wallet_id}/remove | Remove a subwallet
*MultitenancyApi* | [**multitenancy_wallet_wallet_id_token_post**](docs/MultitenancyApi.md#multitenancy_wallet_wallet_id_token_post) | **POST** /multitenancy/wallet/{wallet_id}/token | Get auth token for a subwallet
*MultitenancyApi* | [**multitenancy_wallets_get**](docs/MultitenancyApi.md#multitenancy_wallets_get) | **GET** /multitenancy/wallets | Query subwallets
...
*ResolverApi* | [**resolver_resolve_did_get**](docs/ResolverApi.md#resolver_resolve_did_get) | **GET** /resolver/resolve/{did} | Retrieve doc for requested did
...
*SchemaApi* | [**schemas_schema_id_write_record_post**](docs/SchemaApi.md#schemas_schema_id_write_record_post) | **POST** /schemas/{schema_id}/write_record | Writes a schema non-secret record to the wallet
...
## Documentation For Models
 ...
 - [CreateWalletTokenRequest](docs/CreateWalletTokenRequest.md)
 - [CreateWalletTokenResponse](docs/CreateWalletTokenResponse.md)
 ...
 - [RemoveWalletRequest](docs/RemoveWalletRequest.md)
 ...
 - [SchemasInputDescriptorFilter](docs/SchemasInputDescriptorFilter.md)
 ...
 - [V20CredExFree](docs/V20CredExFree.md)
 ...
 - [WalletRecord](docs/WalletRecord.md)
