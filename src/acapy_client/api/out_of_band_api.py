...
class OutOfBandApi(object):
    ...
    def out_of_band_create_invitation_post(
        self,
        **kwargs
    ):
        ...
        return self.out_of_band_create_invitation_post_endpoint.call_with_http_info(**kwargs)

    def out_of_band_receive_invitation_post(
        self,
        **kwargs
    ):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.out_of_band_receive_invitation_post_endpoint.call_with_http_info(**kwargs)
