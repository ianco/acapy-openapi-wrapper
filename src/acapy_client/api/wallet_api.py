...
class WalletApi(object):
    ...
    def wallet_did_local_rotate_keypair_patch(
        self,
        did,
        **kwargs
    ):
        ...
        kwargs['did'] = \
            did
        return self.wallet_did_local_rotate_keypair_patch_endpoint.call_with_http_info(**kwargs)

    def wallet_did_public_get(
        self,
        **kwargs
    ):
    ...
    def wallet_get_did_endpoint_get(
        self,
        did,
        **kwargs
    ):
    ...
    def wallet_set_did_endpoint_post(
        self,
        **kwargs
    ):
