...
class LedgerApi(object):
    ...
    def ledger_rotate_public_did_keypair_patch(
        self,
        **kwargs
    ):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.ledger_rotate_public_did_keypair_patch_endpoint.call_with_http_info(**kwargs)

    def ledger_taa_accept_post(
        self,
        **kwargs
    ):
