...
class V20PresFormat(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, attach_id, format, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, attach_id, format, *args, **kwargs):  # noqa: E501
        """V20PresFormat - a model defined in OpenAPI
