...
class ConnectionStaticResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, my_did, my_endpoint, my_verkey, record, their_did, their_verkey, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, my_did, my_endpoint, my_verkey, record, their_did, their_verkey, *args, **kwargs):  # noqa: E501
        """ConnectionStaticResult - a model defined in OpenAPI
