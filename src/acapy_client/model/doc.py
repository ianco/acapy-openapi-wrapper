...
def lazy_import():
    from acapy_client.model.signature_options import SignatureOptions
    globals()['SignatureOptions'] = SignatureOptions


class Doc(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'credential': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, credential, options, *args, **kwargs):  # noqa: E501
