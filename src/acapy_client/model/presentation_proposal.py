...
class PresentationProposal(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, presentation_proposal, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, presentation_proposal, *args, **kwargs):  # noqa: E501
        """PresentationProposal - a model defined in OpenAPI
