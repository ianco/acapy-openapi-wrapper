...
class SchemaSendResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, schema_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            schema ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Schema definition. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, schema_id, *args, **kwargs):  # noqa: E501
        """SchemaSendResult - a model defined in OpenAPI
