...
class ResolutionResult(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'did_doc': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, did_doc, metadata, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, did_doc, metadata, *args, **kwargs):  # noqa: E501
        """ResolutionResult - a model defined in OpenAPI
