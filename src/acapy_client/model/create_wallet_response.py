...
class CreateWalletResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key_management_mode, wallet_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            settings (bool, date, datetime, dict, float, int, list, str, none_type): Settings for this wallet.. [optional]  # noqa: E501
            state (str): Current record state. [optional]  # noqa: E501
            token (str): Authorization token to authenticate wallet requests. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, key_management_mode, wallet_id, *args, **kwargs):  # noqa: E501
        """CreateWalletResponse - a model defined in OpenAPI
